...
> **50 travel tools for your AI assistant — flights, hotels, trains, buses, ferries, price alerts, travel hacks, weather forecasts, baggage rules, airport lounges, destination intel. Free. API-first.**
>
...
That's it. Your AI assistant now has 50 travel tools available. Just ask naturally:
...
| **Output schemas** | Full JSON Schema validation for all 50 tool responses |
...
| **MCP** | Full v2025-11-25 — 50 tools (incl. 4 profile tools), 7 prompts, resources, structured content, progress notifications, resource subscriptions, tool description orchestration |
