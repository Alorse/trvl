...
> **34 travel tools for your AI assistant — flights, hotels, trains, buses, ferries, price alerts, travel hacks, weather forecasts, baggage rules, airport lounges, destination intel. Free. API-first.**
>
> Also works as a standalone CLI with 34 commands.
...
Point your AI assistant to the reference docs so it knows all 34 tools:
...
That's it. Your AI assistant now has 34 travel tools available. Just ask naturally:
...
| **Output schemas** | Full JSON Schema validation for all 34 tool responses |
...
| **MCP** | Full v2025-11-25 — 34 tools, 5 prompts, resources, structured content, progress notifications, resource subscriptions, tool description orchestration |
| **CLI** | 34 commands (+ 6 watch subcommands) with table/JSON output, color, shell completion |
