...
> **49 travel tools for your AI assistant — flights, hotels, trains, buses, ferries, price alerts, travel hacks, weather forecasts, baggage rules, airport lounges, destination intel. Free. API-first.**
>
...
| **Output schemas** | Full JSON Schema validation for all 49 tool responses |
...
| **MCP** | Full v2025-11-25 — 49 tools (incl. 3 profile tools), 7 prompts, resources, structured content, progress notifications, resource subscriptions, tool description orchestration |
