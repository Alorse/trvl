...
## CORE TOOLS (selected high-signal tools; trvl exposes 41 MCP tools overall via gateway_invoke server="trvl")
| Tool | Use | Key params |
|------|-----|-----------|
...
| `search_ground` | Bus/train/ferry (18 providers) | from,to,date,[currency,type,provider] |
